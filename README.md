...
1. **Não há Node.js ou dependências de backend necessárias**.
2. Para rodar, basta clonar este repositório e abrir o arquivo `index.html` diretamente em qualquer navegador moderno.
